...
import { Breakpoint, NzDomEventService } from 'ng-zorro-antd/core';
...
export declare class NzDescriptionsComponent implements OnChanges, OnDestroy, AfterContentInit {
    ...
    private destroy$;
    private resize$;
    constructor(cdr: ChangeDetectorRef, mediaMatcher: MediaMatcher, platform: Platform, nzDomEventService: NzDomEventService);
