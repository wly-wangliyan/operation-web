...
export class PushParams extends EntityBase {
  ...
  public free_date_limit_end: number = undefined; // 临近(投保)日期推送天数(push_range为4且free_range_type为1时必传)
  ...
  constructor(entity?: PushEntity) {
    ...
    if (entity) {
      ...
      this.range_type = entity.push_range_detail.range_type;
      this.coupon_id = entity.push_range_detail.coupon_id;
      ...
      this.free_date_limit_end = entity.push_range_detail.free_date_limit_end >= 0 ?
        entity.push_range_detail.free_date_limit_end : (entity.push_range_detail.free_date_limit >= 0 ?
          entity.push_range_detail.free_date_limit : null);
