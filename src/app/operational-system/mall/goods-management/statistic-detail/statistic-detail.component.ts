...
import { GoodsManagementHttpService, CommodityEntity, SearchStatisticParams } from '../goods-management-http.service';
...
export class StatisticDetailComponent implements OnInit, NzSearchAdapter {
  ...
  private requestGoodsDetail(): void {
    this.goodsHttpService.requestCommodityByIdData(this.commodity_id).subscribe(data => {
