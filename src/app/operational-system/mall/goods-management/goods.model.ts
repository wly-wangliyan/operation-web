export class CommodityWriteServiceImportViewModel {
     ...
     */
    public selectedFile(event: any, fileElement: any) {
        this.file = '';
     ...
     *            用url方式表示的base64图片数据
     */
    public dataURLtoFile(dataurl: any, filename: any, file: any) {
    ...
    // 图片压缩
    public dealImage(file: any, path: any, obj: any, callback: any) {
        let con = '';
        const img = new Image();
        img.src = path;
        img.onload = () => {
    ...
    public sizeVertical(file: any, endFile: any) {
