...
@Component({
  selector: 'app-product-editor3',
  templateUrl: './product-editor3.component.html',
  styleUrls: ['./product-editor3.component.css']
})
export class ProductEditor3Component implements OnInit {
        ...
        if (results.sourceUrl) {
          ...
          if (this.importViewModel.uploadImg) {
            ...
            img.onload = () => {
              ...
              if (this.uploadImg) {
                CKEDITOR.instances.editor3.insertHtml(str);
              }
            };
          }
        }
