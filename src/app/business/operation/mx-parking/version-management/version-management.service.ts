...
export class VersionManagementService {
  ...
  /**
   * 请求删除应用
   * @param string application_id 参数
  ...
  /**
   * 请求获取版本列表
   * @param application_id string 应用id
   * @param params SearchVersionParams 参数
  ...
  /**
   * 新建APP
   * @param params AddApplicationParams 参数列表
   * @returns Observable<HttpResponse<any>>
   */
  ...
  /**
   * 新建version
   * @param params AddVersionParams 参数列表
   * @param application_id string ID
   * @returns Observable<HttpResponse<any>>
   */
