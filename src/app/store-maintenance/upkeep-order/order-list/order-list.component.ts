...
import { UpkeepOrderSearchParams, UpkeepOrderEntity, UpkeepOrderService, DoorRefundParams, DoorRefundOrderEntity } from '../upkeep-order.service';
...
export class OrderListComponent implements OnInit, OnDestroy {
  ...
  public onRefundClick(orderItem: UpkeepOrderEntity): void {
    ...
    this.refundParams.refund_fee = orderItem.refund_fee / 100;
