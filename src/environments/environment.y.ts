export const environment = {
  ...
  CAR_SERVE: '//car-service-server-y.parkone.cn',
  COMMENT_SERVE: '//comment-server-y.parkone.cn',
  ...
  TOPIC_DOMAIN: '//social-topic-server-y.parkone.cn',
  INTEGRAL_DOMAIN: '//integral-server-y.parkone.cn'
};
