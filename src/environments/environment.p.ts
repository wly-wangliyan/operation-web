export const environment = {
  ...
  CAR_SERVE: '//car-service-server-pre.parkone.cn',
  COMMENT_SERVE: '//comment-server-pre.parkone.cn',
  TICKET_SERVER: '//ticket-server-pre.parkone.cn',
  MALL_DOMAIN: '//mall-server-pre.parkone.cn',
  STORE_DOMAIN: '//mdby-server-pre.parkone.cn',
  ...
  INTEGRAL_DOMAIN: '//integral-server-pre.parkone.cn'
};
